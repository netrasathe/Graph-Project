...
public abstract class Graph {
    ...
    /** Remove all adjacent edges from V. */
     ...
     *  is present, or 0 otherwise.  This value should always be bounded by
     *  a small multiple of the meximum number of the edges in the graph.
     *  Its purpose is to provide a mapping of edges to integers for use by
     *  classes such as LabeledGraph. It is the same as that returned by
     *  add(u, v). */
